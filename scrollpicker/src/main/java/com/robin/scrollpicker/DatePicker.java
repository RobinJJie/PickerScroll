package com.robin.scrollpicker;
...
public class DatePicker extends LinearLayout implements YearPicker.OnYearSelectedListener,
        MonthPicker.OnMonthSelectedListener, DayPicker.OnDaySelectedListener, MinutePicker.OnMinuteSelectedListener, HourPicker.OnHourSelectedListener {
    ...
    private void initChild() {
        ...
        minutePicker = findViewById(R.id.yearPicker_layout_minut);
        minutePicker.setOnMinuteSelectedListener(this);
        hourPicker = findViewById(R.id.yearPicker_layout_hour);
    ...
    private void onDateSelected() {
        if (mOnDateSelectedListener != null) {
            mOnDateSelectedListener.onDateSelected(getYear(), getMonth(), getDay(), hor, mint);
        }
    }
     ...
     * @param day   the day
     */
    public void setDate(int year, int month, int day, int hour, int mi) {
        setDate(year, month, day, hour, mi, true);
    }
    ...
    public void setDate(int year, int month, int day, int hour, int mi, boolean smoothScroll) {
        ...
        minutePicker.setSelectedMinute(mi, smoothScroll);
    }
     ...
     */
    public void setIndicatorText(String yearText, String monthText, String dayText,String houtxt,String mintxt) {
        mYearPicker.setIndicatorText(yearText);
        mMonthPicker.setIndicatorText(monthText);
        mDayPicker.setIndicatorText(dayText);
        hourPicker.setIndicatorText(houtxt);
        minutePicker.setIndicatorText(mintxt);
    ...
    public interface OnDateSelectedListener {
         ...
         * @param day   the day
         */
        void onDateSelected(int year, int month, int day, int hour, int mint);
    }
}
