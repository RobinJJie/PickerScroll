...
public class DateOutTimePicker extends LinearLayout implements YearPicker.OnYearSelectedListener,
     ...
     */
    public DateOutTimePicker(Context context) {
        this(context, null);
    }
     ...
     */
    public DateOutTimePicker(Context context, @Nullable AttributeSet attrs) {
     ...
     */
    public DateOutTimePicker(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        LayoutInflater.from(context).inflate(R.layout.layout_date_out_time, this);
        initChild();
